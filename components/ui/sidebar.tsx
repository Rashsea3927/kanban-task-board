...
/** Expanded width from `md` up to below `lg` (tablet). */
const SIDEBAR_WIDTH = "16.3125rem";
/** Expanded width from `lg` and up. */
const SIDEBAR_WIDTH_LG = "18.75rem";
...
function SidebarProvider({
  ...
  /** Width from `md` until below `lg`. Falls back to SIDEBAR_WIDTH. */
  sidebarWidth?: string;
  /** Width from `lg` breakpoint upward. Falls back to SIDEBAR_WIDTH_LG. */
  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        style={
          {
            "--sidebar-width-md": sidebarWidth ?? SIDEBAR_WIDTH,
            "--sidebar-width-lg": sidebarWidthLg ?? SIDEBAR_WIDTH_LG,
